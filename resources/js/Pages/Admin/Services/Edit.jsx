        ...
        <MainLayout>
            ...
            >
                ...
                <h1 className="text-3xl md:text-4xl font-display font-bold text-slate-800 mb-2">
                    Edit <span className="text-amber-500">Layanan</span>
                </h1>
                <p className="text-slate-500 font-medium">
                    Sesuaikan detail harga, deskripsi, durasi, atau ubah status
                    layanan.
                </p>
            </motion.div>
                        ...
                        <div className="md:col-span-2 flex items-start gap-4 p-5 bg-slate-900 rounded-2xl border border-slate-800 shadow-md">
                            ...
                            >
                                ...
                                <span className="block text-slate-400 text-sm leading-relaxed">
                                    Hapus centang untuk menonaktifkan. Layanan
                                    yang dinonaktifkan tidak akan terlihat oleh
                                    pelanggan di menu reservasi.
                                </span>
                            </label>
                        </div>
                    </div>
